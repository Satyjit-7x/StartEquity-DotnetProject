...
namespace StartEquity.Migrations
{
    ...
    [Migration("20251010152427_sellshares")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StartEquity.Models.ShareOffer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StartEquity.Models.Transfer", b =>
                {
                    ...
                    b.Property<string>("ShareOfferId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StartEquity.Models.ShareOffer", b =>
                {
                    b.HasOne("StartEquity.Models.Investor", "Buyer")
                        .WithMany()
                    ...
                    b.HasOne("StartEquity.Models.Investment", "Investment")
                        .WithMany()
                        .HasForeignKey("InvestmentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("StartEquity.Models.Investor", "Seller")
                        .WithMany()
            ...
            modelBuilder.Entity("StartEquity.Models.Transfer", b =>
                {
                    ...
                    b.HasOne("StartEquity.Models.ShareOffer", null)
                        .WithMany()
